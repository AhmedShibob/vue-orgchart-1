(function (global, factory) {
  ...
  var OrgChart$1 = function () {
    ...
    createClass(OrgChart, [{
      ...
      value: function _onDrop(event) {
        ...
        axios
          .put(
            `http://dev.getsooty.com:5000/api/organizations/${sNodeInput.dataset.node}/move`,
      ...
      value: function _createNode(nodeData, level) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          nodeDiv.innerHTML = '\n        <div class="title">' + nodeData[opts.nodeTitle].en +'<br/>'+ nodeData[opts.nodeTitle].ar + '</div>\n        ' + (opts.nodeContent ? '<div class="content">' + nodeData[opts.nodeContent] + '</div>' : '') + '\n      ';
  ...
  var clickNode = function clickNode(event) {
    ...
    document.getElementById('selected-node-ar').innerHTML=JSON.parse(sNode.dataset.source).name.ar;
    document.getElementById('selected-node-en').innerHTML=JSON.parse(sNode.dataset.source).name.en;
    sNodeInput.value = sNode.querySelector('.title').textContent;
    var myElement = JSON.parse(sNode.querySelector('.title').parentElement.dataset.source);
